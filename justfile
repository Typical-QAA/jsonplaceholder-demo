...
# [T]est-[AP]i : run all tests from "web" project with local config
[group("playwright")]
test-api *args="": (test-all "" "jsonplaceholder-api" "" args)

# [T]est-[CI] : run all tests tests with CI config
[group("playwright")]
test-ci *args="": (test-all "./environment/playwright-configs/base-ci.config.ts" "" "" args)

# [T]est-[AP]i : run all tests from "web" project with CI config
[group("playwright")]
test-ci-api *args="": (test-all "./environment/playwright-configs/base-ci.config.ts" "jsonplaceholder-api" "" args)
